...
Scenario: Assignment add three then divide
	Given the base number is 100
	When operation + is done to the number 50
	And operation + is done to the number 80
	And operation + is done to the number 80
...
Scenario: Assignment divide then minus then add then modulize
	Given the base number is 100
	When operation / is done to the number 50
